...
"""
def compute_sampleVE(no_of_samples, order, w, k, factors_and_fact_table):
    # check time
    ...
    return Z/no_of_samples,(time.time() - start_time)


"""
Function computes Adaptive sampling from Proposal Distribution as specified in the algorithm
"""
def compute_adaptiveVE(no_of_samples, order, w, k, factors_and_fact_table):
    # log the time
    start_time = time.time()
...
if __name__ == '__main__':
    ...
    if algo_type =='adp':
        approx_val, time_taken = compute_adaptiveVE(sample_size,order, w_cut, k, factors_and_fact_table)
    elif algo_type=='smpl':
        approx_val, time_taken = compute_sampleVE(sample_size,order, w_cut, k, factors_and_fact_table)
    else:
